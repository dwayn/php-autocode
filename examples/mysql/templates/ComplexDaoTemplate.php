 ...
 *
 * __JOIN__MAPS__			array of mapping for tables that this table can be joined to
 *		__DEST__TABLE__		destination table name
 *		__SRC__COL__		column name that the source table joins on (this dao's table)
 *		__DEST__COL__		column that the destination table joins on
 *
 */
 ...
 * @author AutoCoder
 */
class __CLASS__NAME__ extends CFDao
{
...
///////////                        DO NOT MODIFY - GENERATED CODE                               ////////////
	...
	protected static $joinMap = array(
			'__DEST__TABLE__' => array('src_col' => '__SRC__COL__', 'dest_col' => '__DEST__COL__'),/*____REPEATABLE____:__JOIN__MAPS__*/
			);
//////////                                                                                      ////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/*____FUNCTION____START____*/
	...
	public function get($__PRIMARY__KEY__PARMS__)
	{
		...
		// add extra bind created by joins and extra wheres
